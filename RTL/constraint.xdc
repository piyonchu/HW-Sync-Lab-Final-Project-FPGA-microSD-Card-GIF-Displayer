...
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports btn]
set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports filter_btn]
...
## Add drive strength constraints for SD card signals
#set_property DRIVE 4 [get_ports sclk]
#set_property DRIVE 4 [get_ports mosi]
#set_property DRIVE 4 [get_ports cs]

## Force signal registers into IOB for better timing
